...
class Api(object):
    ...
    def GetDirectMessages(self,
        ...
        Returns:
          A sequence of twitter.DirectMessage instances and next_cursor(if return_next_cursor is True)
        """
        ...
        dms = [DirectMessage(
                ...
                id=e['id'],
                recipient_id=e['message_create']['target']['recipient_id'],
